          ...
          child: Center(
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, Routes.transporte);
                    // Acción al hacer click en la segunda imagen
                  },
                  child: Image.asset(
                    'lib/assets/carrito.png', // Asegúrate de que la ruta de tu imagen sea correcta
                    width: MediaQuery.of(context).size.width * 0.2,
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, Routes.denuncia);
                    // Acción al hacer click en la segunda imagen
                  },
                  child: Image.asset(
                    'lib/assets/denuciasin.png', // Asegúrate de que la ruta de tu imagen sea correcta
