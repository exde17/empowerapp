        ...
        Container(
          ...
          decoration: const BoxDecoration(
            ...
            image: DecorationImage(
              image: AssetImage('lib/assets/logoEmpowerapp.png'),
              // Puedes usar `fit: BoxFit.cover` o algún otro BoxFit para controlar cómo se muestra la imagen dentro del espacio asignado
              fit: BoxFit.fill,
            ),
          ),
        ),
        // Image.asset('lib/assets/logoEmpowerapp.png'),
        // const Icon(Icons.'lib/assets/logoEmpowerapp.png', color: Colors.white),
        SizedBox(
